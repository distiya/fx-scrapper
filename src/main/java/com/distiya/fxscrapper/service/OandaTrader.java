    ...
    public void trade(){
        if(!this.portfolioStatus.getIsWarmingUp() && isDailyPreparationCompleted){
            try{
                ...
                double portfolioMargin = (portfolioStatus.getAccount().getMarginAvailable().doubleValue() - appConfigProperties.getBroker().getLeftMargin()) * appConfigProperties.getBroker().getInvestingFactor();
                portfolioStatus.setMargin(portfolioMargin > 0 ? portfolioMargin : 0.0d);
        ...
        if(cl.size() == count && timap.containsKey(key)){
            ...
            if(granularity.equals(portfolioStatus.getLowTradingGranularity())){
                ...
                if(tradeInstrument.getLastLowCandleUpdatedTime() == null || !lastCandleTime.equals(tradeInstrument.getLastLowCandleUpdatedTime())){
                    ...
                    tradeInstrument.getCurrentAdxLowIndicator().update(tradeInstrument.getCurrentLowMarket());
                ...
                if(tradeInstrument.getLastHighCandleUpdatedTime() == null || !lastCandleTime.equals(tradeInstrument.getLastHighCandleUpdatedTime())){
                    ...
                    tradeInstrument.getCurrentAdxHighIndicator().update(tradeInstrument.getCurrentHighMarket());
